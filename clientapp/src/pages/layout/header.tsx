        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <Link className="nav-link active text-white" aria-current="page" href={"/aboutus"}><FontAwesomeIcon icon={faCircleQuestion}/>&nbsp;About Us</Link>
            </li>
            ...
            <li className="nav-item">
              <Link className="nav-link text-white active" href={"/contactus"}><FontAwesomeIcon icon={faMapLocation}/>&nbsp;Contact Us</Link>
            </li>
          </ul>
