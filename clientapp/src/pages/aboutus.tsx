...
const Aboutus = () => {
    ...
    <div className="card border-1 mx-5 border-white bg-black">
        ...
        <div className="card-text bg-success">
            <p className="text-light mx-3 mt-2">
                <div>Our primary goals of a supercar company revolve around performance, exclusivity, and financial success. These companies aim to produce vehicles with exceptional speed, handling, and advanced technology, often in limited quantities, to justify high price tags. They also strive to build a strong brand identity and cultivate a loyal customer base.</div>
            </p>
